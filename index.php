<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=='POST'){
        ...
        $rat = $_POST['rating'];
        $rate = $rat/5;
        $sql2 = "INSERT INTO deepak(username,movie,rating)VALUES('$name','$mov','$rate')";   
...
<body>
    <div class="form-style-5">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <fieldset>
            <legend><span class="number">1</span>Movie Rating</legend>
            ...
            <legend><span class="number">2</span>Show Movies</legend>
        </form>
